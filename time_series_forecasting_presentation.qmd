...
Predictive accuracy is typically the focus, not using inference to understand underlying causes.
...
-   Knowing more about the future changes how we act today.

-   Improve decisionmaking about the future.
